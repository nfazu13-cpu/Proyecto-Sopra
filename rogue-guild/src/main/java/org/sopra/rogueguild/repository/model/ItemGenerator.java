        ...
        do {
            ...
            switch (randomPrefix) {
                case 1:
                    ...
                    randomBasePrice = ((int) (Math.random() * 41) + 20) * 5;
                    
                    nameItem += " " + NATURE_SUFIXES[(int) (Math.random() * NATURE_SUFIXES.length)];

                    int randomDamage = 0;
                    //TODO por ahora el random damage no cumple con nada establecido por los tickets de Taiga
                ...
                case 2:
                    ...
                    randomBasePrice = ((int) (Math.random() * 31) + 10) * 5;
                    
                    nameItem += " " + NATURE_SUFIXES[(int) (Math.random() * NATURE_SUFIXES.length)];

                    int randomShield = 0;
                    //TODO por ahora el random shield no cumple con nada establecido por los tickets de Taiga
                ...
                case 3:
                    ...
                    randomBasePrice = ((int) (Math.random() * 7) + 2) * 5;
                ...
                case 4:
                    ...
                    randomBasePrice = ((int) (Math.random() * 27) + 4) * 5;
                ...
                case 5:
                    ...
                    randomBasePrice = ((int) (Math.random() * 17) + 4) * 5;
